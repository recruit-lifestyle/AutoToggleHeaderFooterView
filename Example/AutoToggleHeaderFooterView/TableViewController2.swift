...
final class TableViewController2: UIViewController, UITableViewDelegate {

    static let name = "TableView+Header"
    ...
    deinit {
        print("deinit: " + TableViewController2.name)
    }
    ...
    override func viewDidLoad() {
        ...
        autoToggleView = AutoToggleHeaderFooterView(header: header, footer: nil)
